...
public class DepartmentFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        submitButtonDepartment = view.findViewById(R.id.submitButtonDepartment);
        cancelButton = view.findViewById(R.id.cancelButton);
        RadioGroup g = view.findViewById(R.id.departmentRadioGroup);
        submitButtonDepartment.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                ...
                mListener.departmentChosen(department);
            }
        });
        cancelButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                mListener.cancelClicked(cancel);
            }
        });
        return view;
    }
    ...
    public interface departmentListener{
        void departmentChosen(String department);
        void cancelClicked(boolean cancel);
    }
}